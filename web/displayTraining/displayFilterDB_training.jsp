...
<html>
    ...
    <body>  
        ...
        <%--sql:setDataSource driver="com.microsoft.sqlserver.jdbc.SQLServerDriver" user="sa" password="rtdx9900" 
        ...
        <table id="mytable" class="showTable">
            ...
            <c:forEach var="row" items="${rs.rows}">
                <tr>
                    ...
                    <td>
                        <a href='../testing/filterTesting_yahoofinance.jsp?sendFilter=true&bestN=${row['bestN']}&bestK=${row['bestK']}'>測試參數</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
