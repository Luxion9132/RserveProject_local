...
formtowizard.prototype={
	...
	validate:function(section){
		...
		var validated=true, invalidtext=["請填寫欄位:\n"]
	...
	init:function(setting){
		...
		jQuery(function($){ //on document.ready
			...
			var $paginatediv=$('<div class="formpaginate" style="overflow:hidden;"><span class="prev" style="float:left">上一頁</span> <span class="status">Step 1 of </span> <span class="next" style="float:right">下一頁</span></div>')
